...
window._rhSinBuildLayout = function() {
    return [
        ...
        '<input type="search" id="rh-sin-search" placeholder="Buscar por colaborador ou nº do BO..." oninput="window.rhSinFiltrarLista()" style="width:100%; padding:0.45rem 0.7rem 0.45rem 34px; border:1px solid #cbd5e1; border-radius:6px; font-size:0.82rem; outline:none; box-sizing:border-box;" autocomplete="new-password" readonly onfocus="this.removeAttribute(\'readonly\');">',
        '</div>',
...
window.initRhLogisticaMultas = async function() {
    ...
    container.id = 'rh-multas-logistica-container';
    var RH_STATUS_PERMITIDOS = ['Indicado', 'Multa NIC', 'Id. Indeferida', 'Id. Deferida', 'Cobrada - Pz. Perdido'];
    try {
