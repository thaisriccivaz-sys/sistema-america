...
const BREADCRUMB_MAP = {
    ...
    'tab:00. CheckList':          { path: 'Colaboradores → Prontuário Digital → 00. CheckList',         code: 'RHCL01-CK' },
    'tab:01. Ficha Cadastral':    { path: 'Colaboradores → Prontuário Digital → Ficha Cadastral',       code: 'RHCL01-FC' },
    'tab:Ficha Cadastral':        { path: 'Colaboradores → Prontuário Digital → Ficha Cadastral',       code: 'RHCL01-FC' },
    'tab:Pagamentos':             { path: 'Colaboradores → Prontuário Digital → Pagamentos',            code: 'RHCL02' },
    'tab:ASO':                    { path: 'Colaboradores → Prontuário Digital → ASO',                   code: 'RHCL03-A' },
    'tab:Ficha de EPI':           { path: 'Colaboradores → Prontuário Digital → Ficha de EPI',          code: 'RHCL04' },
    'tab:Atestados':              { path: 'Colaboradores → Prontuário Digital → Atestados',             code: 'RHCL05-A' },
    'tab:Faltas':                 { path: 'Colaboradores → Prontuário Digital → Faltas',                code: 'RHCL06-F' },
    'tab:Contratos':              { path: 'Colaboradores → Prontuário Digital → Contratos',             code: 'RHCL07-C' },
    'tab:Avaliação':              { path: 'Colaboradores → Prontuário Digital → Avaliação',             code: 'RHCL08-V' },
    'tab:Avaliações':             { path: 'Colaboradores → Prontuário Digital → Avaliações',            code: 'RHCL08-V' },
    'tab:Advertências':           { path: 'Colaboradores → Prontuário Digital → Advertências',          code: 'RHCL09-A' },
    'tab:Faculdade':              { path: 'Colaboradores → Prontuário Digital → Faculdade',             code: 'RHCL10-F' },
    'tab:Boletim de ocorrência':  { path: 'Colaboradores → Prontuário Digital → Boletim de Ocorrência', code: 'RHCL11-B' },
    'tab:Certificados':           { path: 'Colaboradores → Prontuário Digital → Certificados',          code: 'RHCL12-C' },
    'tab:Conjuge':                { path: 'Colaboradores → Prontuário Digital → Conjuge',               code: 'RHCL13-C' },
    'tab:Dependentes':            { path: 'Colaboradores → Prontuário Digital → Dependentes',           code: 'RHCL14-D' },
    'tab:Fotos':                  { path: 'Colaboradores → Prontuário Digital → Fotos',                 code: 'RHCL15-F' },
    'tab:Multas':                 { path: 'Colaboradores → Prontuário Digital → Multas',                code: 'RHCL16-M' },
    'tab:NRs':                    { path: 'Colaboradores → Prontuário Digital → NRs',                   code: 'RHCL17-N' },
    'tab:Terapia':                { path: 'Colaboradores → Prontuário Digital → Terapia',               code: 'RHCL18-T' },
    'tab:Treinamento':            { path: 'Colaboradores → Prontuário Digital → Treinamento',           code: 'RHCL19-T' },
    'tab:Documentos':             { path: 'Colaboradores → Prontuário Digital → Documentos',            code: 'RHCL20' },
    'tab:Afastamentos':           { path: 'Colaboradores → Prontuário Digital → Afastamentos',          code: 'RHCL21' },
    'tab:Chaves':                 { path: 'Colaboradores → Prontuário Digital → Chaves',                code: 'RHCL22' },
    'tab:Prontuário Digital':     { path: 'Colaboradores → Prontuário Digital',                         code: 'RHCL00-P' },
};
