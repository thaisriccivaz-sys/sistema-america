        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1rem; flex-wrap:wrap; gap:1rem;">
            ...
            <div style="display:flex; gap:0.5rem; align-items:center; flex-wrap:wrap;">
                ...
                <div style="display:flex; gap:0.5rem; align-items:center; margin-right:0.5rem;">
                    ...
                    <button class="btn-tipo-cadastro" data-status="Iniciado" onclick="selecionarTipoCadastro(this, 'Iniciado')" style="padding:0.35rem 0.75rem; border:none; border-radius:999px; font-size:0.8rem; font-weight:600; cursor:pointer; background:#f3e8ff; color:#7e22ce; display:flex; gap:4px; align-items:center; transition:0.2s; opacity:0.5;"><i class="ph ph-play-circle"></i> Iniciado</button>
