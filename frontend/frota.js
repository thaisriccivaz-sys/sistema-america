...
window.initFrotaVeiculos = async function() {
  ...
  c.innerHTML = `<div style="padding:1.5rem;background:#f1f5f9;height:100%;box-sizing:border-box;display:flex;flex-direction:column;overflow:hidden;">
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem;flex-wrap:wrap;gap:1rem;flex-shrink:0;">
...
<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.08);overflow:auto;flex:1;min-height:0;">
