...
(function(){
    ...
    function renderModalEmail() {
        ...
        return '<div id="modal-email-cadastro" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;align-items:center;justify-content:center;">'+
            ...
            '<div style="position:relative;"><label style="font-size:0.8rem;font-weight:600;display:block;margin-bottom:4px;display:flex;align-items:center;gap:5px;"><i class="ph ph-lock-key" style="color:#4f46e5;"></i> Senha</label><div style="position:relative;"><input id="email-cad-senha" type="password" autocomplete="new-password" value="'+(e?e.senha||'':'')+'" style="width:100%;padding:0.5rem 2.5rem 0.5rem 0.75rem;border:1.5px solid #e2e8f0;border-radius:8px;font-size:0.85rem;box-sizing:border-box;font-family:monospace;letter-spacing:0.1em;"><button type="button" onclick="(function(){var i=document.getElementById(\'email-cad-senha\');var b=document.getElementById(\'btn-toggle-senha-email\');i.type=i.type===\'password\'?\'text\':\'password\';b.querySelector(\'i\').className=i.type===\'password\'?\'ph ph-eye\':\'ph ph-eye-slash\';})()" id="btn-toggle-senha-email" style="position:absolute;right:0.5rem;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#94a3b8;padding:4px;"><i class="ph ph-eye"></i></button></div><p style="font-size:0.72rem;color:#94a3b8;margin:3px 0 0 0;"><i class="ph ph-shield-check" style="color:#4f46e5;"></i> Armazenada de forma criptografada</p></div>'+
