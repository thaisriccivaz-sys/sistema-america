...
(function () {
    ...
    window._desToggleMainTab = function(tabName) {
    ...
    function render(container) {
        ...
        <div id="sat-root">
            ...
            <div style="display: flex; gap: 1rem; border-bottom: 2px solid #e2e8f0; margin-bottom: 1.5rem;">
                ...
                <button id="tab-btn-relatorios" onclick="window._desToggleMainTab('relatorios')" style="padding: 0.5rem 1rem; font-weight: 600; color: #64748b; border-bottom: 3px solid transparent; background: none; border-top: none; border-left: none; border-right: none; cursor: pointer;">
...
/* ── FILTER & SORT ──────────────────────────────────────── */
    ...
    window._desRhRbtnClick = function(el, isReadonly) {
                ...
                for(let v=1; v<=5; v++) {
                    ...
                    <label style="cursor:pointer; position:relative; margin:0;" title="Nota ${v}">
                        ...
                        <div class="sat-rbtn" data-color="${c}" data-bg="${c}" data-group="av_${catIdx}_${idx}"
                             ...
                             onclick="window._desRhRbtnClick(this, ${isReadonly ? 'true' : 'false'})">
                            ${v}
                        </div>
                    </label>`;
                }
