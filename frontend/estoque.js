        ...
        table.innerHTML = data.map(item => {
            ...
            return '<tr style="' + (isLow ? "background:#fff5f5;" : "") + '">' +
                ...
                '<td style="text-align:right;white-space:nowrap;">' +
                    ...
                    '<button class="btn btn-sm btn-secondary" onclick="window.editarEstoque(window._estoqueCache[' + item.id + '])" title="Editar" style="margin-left:6px;"><i class="ph ph-pencil-simple"></i></button>' +
