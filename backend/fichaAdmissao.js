...
function getFichaAdmissaoHtml(colaborador) {
    ...
    // Lógica para Documentos Dinâmicos
    ...
    let docIdentidade = 'Documento de Identidade';
    if (c.motorista === 'Sim' || c.rg_tipo === 'CNH') {
        docIdentidade = 'CNH';
    } else if (c.rg_tipo === 'CIN') {
        docIdentidade = 'CIN';
    } else if (c.rg_tipo === 'RG') {
        docIdentidade = 'RG';
    } else {
        docIdentidade = 'RG / CNH / CIN';
    }
    ...
    <head>
        ...
        <style>
            ...
            .checkbox-item { margin-bottom: 8px; font-size: 12px; display: flex; align-items: center; }
            .checkbox-box { display: inline-block; width: 14px; height: 14px; border: 1px solid #000; margin-right: 10px; box-sizing: border-box; }
        </style>
    </head>
    <body>
        ...
        <div style="margin-top: 30px; border: 2px dashed #2F5597; padding: 15px; border-radius: 8px;">
            <div style="font-weight: bold; font-size: 13px; color: #2F5597; margin-bottom: 12px; text-align: center;">DOCUMENTOS QUE DEVEM SER ANEXADOS NA FICHA CADASTRAL E PRONTUÁRIO</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> Título de eleitor</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> ${certidao}</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> Comprovante de endereço (Com data de vencimento)</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> Histórico escolar</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> Reservista (quando for homem)</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> ${docIdentidade}</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> ASO (2026) (que foi anexado via prontuário ou via admissão passo 4 - assinado via certificado digital)</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> Carteira de Vacinação</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> Curriculum</div>
            <div class="checkbox-item"><span class="checkbox-box"></span> CTPSD</div>
        </div>
