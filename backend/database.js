...
const db = new sqlite3.Database(dbPath, (err) => {
    if (err) {
        ...
        db.serialize(() => {
            ...
            // [MIGRAÇÃO] Excluir departamento comercial criado com código errado
            db.run(`DELETE FROM departamentos WHERE id = 45701`);
            ...
            db.serialize(() => {
                ...
                db.all("PRAGMA table_info(colaboradores)", (err, rows) => {
                    ...
                    db.serialize(() => {
                        ...
                        if (!cols.includes('motorista_avaliador')) db.run("ALTER TABLE colaboradores ADD COLUMN motorista_avaliador TEXT DEFAULT 'Não'", (err) => {});
                    });
                });
...
db.run("PRAGMA foreign_keys = ON;");
            ...
            db.run(`
                CREATE TABLE IF NOT EXISTS frota_categorias_manutencao (
                    id INTEGER PRIMARY KEY AUTOINCREMENT,
                    nome TEXT NOT NULL UNIQUE,
            ...
            // Tabela do catalogo de servicos
            db.run(`
                CREATE TABLE IF NOT EXISTS frota_servicos_catalogo (
                    id INTEGER PRIMARY KEY AUTOINCREMENT,
            ...
            `, (err) => {
                ...
                // Novas tabelas de plano customizado
